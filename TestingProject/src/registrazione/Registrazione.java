...
public class Registrazione {
    ...
    public void inserisciEmail(String em)  throws IllegalArgumentException {
    ...
    public String getPassrip() {
    	
    	return passwrip;
    }
    
    public void inserisciPassRip(String pass) throws IllegalArgumentException {
    	
    	if(this.password.equals(pass))
    		this.passwrip=pass;
    	else
    		throw new IllegalArgumentException("La password non corrisponde");
